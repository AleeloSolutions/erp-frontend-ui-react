/**
 * Superseded and entirely commented out. The themeable engine in this
 * folder's parent replaced it; `InvoicePrintDocumentClassic` is what the
 * print route actually renders. Kept deliberately rather than deleted --
 * the commented markup below is the only record of the first print layout,
 * which predates the settings-driven system.
 *
 * Not exported from the package barrel. The two imports it references in
 * comments (`@erp/ui`, `@/modules/sales/api`) are pre-migration paths and
 * no longer resolve from here.
 */
