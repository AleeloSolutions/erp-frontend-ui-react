import logoUrl from "../fixtures/germany-ltd-logo.png";

/** This layout's own line shape. Declared here rather than imported from
 * the API: the report is a fixed external design being replicated, so it
 * must not move every time the invoice model does. The page that renders
 * it maps the API's lines into this. */
