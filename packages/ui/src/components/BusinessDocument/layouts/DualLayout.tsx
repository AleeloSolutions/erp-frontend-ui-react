...
import { DocumentMeta } from "../parts/DocumentMeta";
import { DocumentSeal } from "../parts/DocumentSeal";
import { DocumentStub } from "../parts/DocumentStub";
import { DocumentFold } from "../parts/DocumentFold";
import { DocumentLogoBadge } from "../parts/DocumentLogoBadge";
import { DocumentPaymentInfo } from "../parts/DocumentPaymentInfo";
import { LEDGER_SEAL_THEME_CSS, ledgerSealThemeVars, FRAUNCES } from "../parts/theme";
import { companyInitials } from "../lib/companyInitials";
import { tableStyles } from "../config/tableStyles";
import { buildDocumentQrValue } from "../lib/buildQrValue";
import { DocumentSpine } from "../parts/DocumentSpine";
...
export function DualLayout({ data, settings }: DualLayoutProps) {
  ...
  return (
    ...
    >
      ...
      <DocumentSpine primary={primary} secondary={secondary} />
        ...
        <div className="relative z-[2] mt-5 flex items-start justify-between gap-6">
          <div className="min-w-0 flex-1 text-[11.5px]">
            <DocumentPaymentInfo
              ...
              qrValue={settings.showQrCode ? buildDocumentQrValue(data) : undefined}
            />
          </div>
          <DocumentStub totals={data.totals} primary={primary} />
        </div>
