 ...
 * child — same trick Bubble's shared `DocumentFooter` uses internally.
 */
 ...
 * ticket-stub box or colored bar, unlike the shared `DocumentStub` other
...
export function CenterLayout({ data, settings }: CenterLayoutProps) {
