...
import { LEDGER_SEAL_THEME_CSS, ledgerSealThemeVars } from "./parts/theme";
...
export interface DocumentCustomizerHandle {
  continue: () => void;
  discard: () => void;
}
 ...
 * `settings` in local state, right panel re-renders `DocumentPreview`
 ...
 */
export const DocumentCustomizer = forwardRef<
  DocumentCustomizerHandle,
  DocumentCustomizerProps
>(function DocumentCustomizer(
  {
    data,
    defaultSettings,
    onContinue,
        ...
        >
          ...
          {isModal || embedded ? (
            ...
            >
              ...
              >
                <DocumentPreview data={data} settings={settings} />
              </div>
            </div>
          ) : (
            <DocumentPreview data={data} settings={settings} />
...
DocumentCustomizer.displayName = "DocumentCustomizer";
