...
| Routes           | Feature routes live in each module (`modules/<name>/routes.tsx`). `apps/erp/src/routes.tsx` only mounts app pages and module prefixes (`/sales/*`, `/notes/*`, …).                       |
...
_Amendments are recorded here. Prefer updating this file over silent process drift._
