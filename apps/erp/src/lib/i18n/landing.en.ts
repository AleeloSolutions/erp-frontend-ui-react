/** App-level marketing landing copy (`landing` namespace). */
export const landingEn = {
  ...
  getStarted: "Get started",
  hero: {
    eyebrow: "Modern business platform",
    titleBefore: "Run your operations on",
    titleEmphasis: "one system.",
  ...
  showcase: {
    ...
    paragraph2a: "Customers, sales, products, and financial reports",
